...
PanGenie [v2.1.0](https://github.com/eblerjana/pangenie/releases/tag/v2.1.0) was used throughout. Intermediate files and a high level description are available [here](https://doi.org/10.5281/zenodo.7669083) and [here](https://zenodo.org/record/7669083/files/README.txt), respectively. 
